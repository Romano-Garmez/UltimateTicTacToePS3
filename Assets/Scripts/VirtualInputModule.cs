...
namespace UnityEngine.EventSystems
{
    ...
    public class VirtualInputModule : PointerInputModule
    {
        ...
        public override bool ShouldActivateModule()
        {
            ...
            shouldActivate |= Input.GetButtonDown("Fire1"); // Check for gamepad button press
        ...
        protected bool SendMoveEventToSelectedObject()
        {
            ...
            bool allow =
                Input.GetButtonDown(m_HorizontalAxis) || Input.GetButtonDown(m_VerticalAxis);
        ...
        protected void ProcessMouseEvent(int id)
        {
            ...
            // Process gamepad button press as mouse click
            if (Input.GetButtonDown("Fire1"))
            {
                leftButtonData.buttonData.pressPosition = leftButtonData.buttonData.position;
                leftButtonData.buttonData.pointerPressRaycast = leftButtonData
                    .buttonData
                ...
                leftButtonData.buttonData.pointerPress = newPressed;
                leftButtonData.buttonData.rawPointerPress = leftButtonData
                    .buttonData
                    .pointerCurrentRaycast
                    .gameObject;

                leftButtonData.buttonData.eligibleForClick = true;
                leftButtonData.buttonData.delta = Vector2.zero;
                leftButtonData.buttonData.dragging = false;
                leftButtonData.buttonData.useDragThreshold = true;
                leftButtonData.buttonData.clickCount = 1;
                leftButtonData.buttonData.clickTime = Time.unscaledTime;

                // Save the drag handler as well
                leftButtonData.buttonData.pointerDrag = ExecuteEvents.GetEventHandler<IDragHandler>(
                    leftButtonData.buttonData.pointerCurrentRaycast.gameObject
                );

                if (leftButtonData.buttonData.pointerDrag != null)
                    ExecuteEvents.Execute(
                        leftButtonData.buttonData.pointerDrag,
                        leftButtonData.buttonData,
            ...
            {
                ExecuteEvents.Execute(
                    leftButtonData.buttonData.pointerPress,
                    leftButtonData.buttonData,
                ...
                if (
                    leftButtonData.buttonData.pointerPress == pointerUpHandler
                    && leftButtonData.buttonData.eligibleForClick
                )
                {
                    ExecuteEvents.Execute(
                        leftButtonData.buttonData.pointerPress,
                    ...
                    leftButtonData.buttonData.pointerDrag != null
                    && leftButtonData.buttonData.dragging
                )
                {
                    ExecuteEvents.ExecuteHierarchy(
                        leftButtonData.buttonData.pointerCurrentRaycast.gameObject,
                ...
                leftButtonData.buttonData.eligibleForClick = false;
                leftButtonData.buttonData.pointerPress = null;
                leftButtonData.buttonData.rawPointerPress = null;
        ...
        protected override MouseState GetMousePointerEventData(int id)
        {
            ...
            var screenSpaceCursorPosition = RectTransformUtility.WorldToScreenPoint(
                m_canvasCamera,
